// image offset 0x11EDA0 address 7ff7a32aeda0

/* WARNING: Function: __security_check_cookie replaced with injection: security_check_cookie */

undefined8 FUN_7ff7a32aeda0(longlong param_1)
...
LAB_7ff7a32aee19:
  ...
  if (*(longlong *)(param_1 + 0x50) + 0x20U < *(ulonglong *)(param_1 + 0x48)) {
    fVar8 = (float)FUN_7ff7a3469aa0(param_1);
    iVar6 = (int)fVar8;
    if (iVar6 != 0) goto LAB_7ff7a32aee95;
  }
  else {
    iVar6 = 0;
  }
...
LAB_7ff7a32aee95:
  ...
  cVar2 = FUN_7ff7a3406560(iVar3,iVar4,iVar6,local_38);
