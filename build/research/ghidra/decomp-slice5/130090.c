// image offset 0x130090 address 7ff7a32c0090

undefined8 FUN_7ff7a32c0090(longlong param_1)

{
  ...
  if (((int)((longlong)(*(ulonglong *)(param_1 + 0x48) - *(ulonglong *)(param_1 + 0x50)) >> 4) == 2)
    ...
    if ((iVar1 != 0) && (*(longlong *)(param_1 + 0x50) + 0x10U < *(ulonglong *)(param_1 + 0x48))) {
      iVar1 = FUN_7ff7a3468d90(param_1);
      if (iVar1 != 0) goto LAB_7ff7a32c00f3;
    }
  }
...
LAB_7ff7a32c00f3:
  ...
  FUN_7ff7a39db410(iVar4,iVar1);
  FUN_7ff7a39db450(iVar4);
  FUN_7ff7a39da7e0(iVar4);
  return 0;
}
