// image offset 0x125390 address 7ff7a32b5390

undefined8 FUN_7ff7a32b5390(longlong param_1)

{
  ...
  if (uVar3 < uVar2) {
    ...
    if (iVar1 == 0) goto LAB_7ff7a32b53e6;
  }
  else {
LAB_7ff7a32b53e6:
    FUN_7ff7a34731a0(param_1,&DAT_7ff7a3cbd562);
  ...
  if (*(longlong *)(param_1 + 0x50) + 0x10U < *(ulonglong *)(param_1 + 0x48)) {
    iVar1 = FUN_7ff7a3468d90(param_1);
    if (iVar1 == 0) goto LAB_7ff7a32b540f;
  }
  else {
LAB_7ff7a32b540f:
    FUN_7ff7a34731a0(param_1,&DAT_7ff7a3cbd562);
  ...
  if (*(longlong *)(param_1 + 0x50) + 0x20U < *(ulonglong *)(param_1 + 0x48)) {
    iVar1 = FUN_7ff7a3468d90(param_1);
    if (iVar1 != 0) goto LAB_7ff7a32b5447;
  }
  FUN_7ff7a34731a0(param_1,&DAT_7ff7a3cbd562);
LAB_7ff7a32b5447:
  ...
  FUN_7ff7a3502a70((int)fVar5,iVar4,iVar1);
  return 0;
}
