// image offset 0x125780 address 7ff7a32b5780

undefined8 FUN_7ff7a32b5780(longlong param_1)

{
  ...
  if (uVar3 < uVar2) {
    ...
    if (iVar1 == 0) goto LAB_7ff7a32b57d6;
  }
  else {
LAB_7ff7a32b57d6:
    FUN_7ff7a34731a0(param_1,&DAT_7ff7a3cbd562);
  ...
  if (*(longlong *)(param_1 + 0x50) + 0x10U < *(ulonglong *)(param_1 + 0x48)) {
    iVar1 = FUN_7ff7a3468d90(param_1);
    if (iVar1 == 0) goto LAB_7ff7a32b57ff;
  }
  else {
LAB_7ff7a32b57ff:
    FUN_7ff7a34731a0(param_1,&DAT_7ff7a3cbd562);
  ...
  if (*(longlong *)(param_1 + 0x50) + 0x20U < *(ulonglong *)(param_1 + 0x48)) {
    iVar1 = FUN_7ff7a3468d90(param_1);
    if (iVar1 != 0) goto LAB_7ff7a32b5837;
  }
  FUN_7ff7a34731a0(param_1,&DAT_7ff7a3cbd562);
LAB_7ff7a32b5837:
  ...
  FUN_7ff7a35026f0((int)fVar5,iVar4,iVar1);
  return 0;
}
