// image offset 0x11E210 address 7ff7a32ae210

/* WARNING: Function: __chkstk replaced with injection: alloca_probe */
/* WARNING: Function: __security_check_cookie replaced with injection: security_check_cookie */

undefined8 FUN_7ff7a32ae210(longlong param_1)

{
  ...
  if (((int)((longlong)(*(ulonglong *)(param_1 + 0x48) - *(ulonglong *)(param_1 + 0x50)) >> 4) == 3)
    ...
    if ((iVar7 != 0) && (*(longlong *)(param_1 + 0x50) + 0x10U < *(ulonglong *)(param_1 + 0x48))) {
      ...
      {
        iVar7 = FUN_7ff7a3468d90(param_1);
        if (iVar7 != 0) goto LAB_7ff7a32ae2ab;
      }
    }
  }
  ...
  if (0 < iVar7) {
    ...
    do {
      ...
      *(longlong *)(param_1 + 0x48) = *(longlong *)(param_1 + 0x48) + -0x20;
      FUN_7ff7a325c620("expirationType",*(undefined4 *)((longlong)puVar14 + -4),DAT_7ff7a4d63d08);
      uVar6 = DAT_7ff7a4d63d08;
      iVar12 = *(int *)((longlong)puVar14 + -4);
      if (iVar12 == 1) {
        FUN_7ff7a325c620("quantity",*(undefined4 *)puVar14,DAT_7ff7a4d63d08);
      }
      else if (iVar12 == 2) {
        uVar9 = FUN_7ff7a38fa3d0(&DAT_7ff7a3ccb10c,*puVar14);
        FUN_7ff7a325c810("usageDuration",uVar9,uVar6);
      }
      else if (iVar12 == 3) {
        uVar9 = FUN_7ff7a38fa3d0(&DAT_7ff7a3ccb10c,*puVar14);
        FUN_7ff7a325c810("rentalDuration",uVar9,uVar6);
      }
      else if (iVar12 == 4) {
